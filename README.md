...
I’m a **full stack developer** specializing in **front-end** (**React, JavaScript**) and **back-end** (**Python, Node.js**) development. ⚡ I build **responsive interfaces** and **reliable systems**, collaborating in **Agile teams** to deliver **quality projects**. 💡 Passionate about **problem-solving** and **performance optimization**, I’m eager to explore **AWS** and expand my skillset. 🚀  
