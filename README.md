...
My passion began when I watched a blank screen come to life with just HTML, CSS, and JavaScript, a drive that earned me a spot at **WeThinkCode_ (NQF 6)**. At this elite institution, I mastered peer-to-peer software engineering, object-oriented programming, and brownfield codebase navigation. Specializing in their Service-Oriented Architecture elective, I gained deep expertise in service decomposition, asynchronous communication, and cross-service communication via message queues.

Today, I optimize my daily development workflow using AI tools to write better code faster. I find immense fulfillment in showcasing functional work to family and friends while currently upskilling in Azure.
